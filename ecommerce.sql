...
create table product(
        ...
        category enum('Eletrônico','Moda','Brinquedos','Alimentos','Esporte','Papelaria','Livros','Ferramentas','Cozinha','Pet Shop','Móveis') not null,
...
create table payments(
		idClient int,
        idPayment int,
        typePayment enum('Bolet','Cartão','Dois Cartões'),
